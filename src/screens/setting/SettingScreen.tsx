...
const SettingScreen = () => {
  const { deleteModalVisible, setDeleteModalVisible, onFeedback, onDeleteAccount, logoutMutation } =
    useSetting();
  const {
    diaryNotiEnabled,
    letterNotiEnabled,
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.basicPadding}>
          ...
          <SettingSection label="로그아웃" buttonText="나가기" onPress={logoutMutation.mutate} />
